"""Add cascade delete to custom objects

Revision ID: dee570bf6975
Revises: 381bdc18f7bb
Create Date: 2025-10-09 23:04:31.848448
...
revision: str = 'dee570bf6975'
down_revision: Union[str, Sequence[str], None] = '381bdc18f7bb'
...
def upgrade() -> None:
    ...
    op.drop_table('custom_entity_records')
    op.drop_table('custom_entity_types')
